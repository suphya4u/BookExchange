...
public class MyBooksActivity extends BookListActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    Button addBookButton = (Button) findViewById(R.id.add_book_button);
    addBookButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        Intent intent = new Intent(MyBooksActivity.this, SearchBookActivity.class);
        startActivityForResult(intent, 0);
      }
    });

    bookListView = (RecyclerView) findViewById(R.id.my_books_list);
  ...
  protected String getListType() {
    return Constants.BOOK_LIST_TYPE_MY_BOOKS;
  }
}
